...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Katmancoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    ...
    0x0e001fac, 0x0f001fac, 0x10001fac, 0xe21d0b03, 0xb3ab0803, //katmancoin nodes
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Katmancoin is probably already running."), addrBind.ToString().c_str());
        else
